  ...
  module ChefConf16
    class AppengineDeploy < Chef::Resource
      ...
      def initialize(args = {})
        ...
        @version_id = args[:version_id].nil? ?  Time.new.iso8601.to_s.delete('-').delete(':').delete('+').downcase : args[:version_id]
